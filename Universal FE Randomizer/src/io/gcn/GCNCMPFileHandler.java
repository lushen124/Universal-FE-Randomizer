...
//			} catch (GCNISOException e) {
			if (name.endsWith(".bin")) {
				gcnFileHandler = new GCNDataFileHandler(entry, handler, Arrays.copyOfRange(decompressed, (int)cmpFileEntry.filePointer, (int)cmpFileEntry.filePointer + (int)cmpFileEntry.fileLength), identifier + "/" + name);
