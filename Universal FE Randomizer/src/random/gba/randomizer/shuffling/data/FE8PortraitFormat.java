 ...
 */
public class FE8PortraitFormat extends PortraitFormat {
	...
	public List<PortraitChunkInfo> getMainPortraitChunks() {
		...
		result.add(new PortraitChunkInfo(new Rectangle(12, 6, 4, 2), new Point(24, 0))); 
	...
	public Optional<byte[]> getMainPortraitPrefix() {
		return Optional.of(new byte[] {0x0, 0x4, 0x10, 0x0});
	}
